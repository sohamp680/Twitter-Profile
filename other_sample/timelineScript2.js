...
console.log(users);
// users.forEach((user) => {
//     let newUser = (({ userName,displayName,joinedDate,followingCount,followerCount,avatarURL,coverPhotoURL }) => ({ userName,displayName,joinedDate,followingCount,followerCount,avatarURL,coverPhotoURL }))(user);
//     }
// );
// console.log(newUser);
